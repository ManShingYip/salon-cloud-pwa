...
ALTER TABLE appointments DROP CONSTRAINT IF EXISTS appointments_new_created_by_fkey CASCADE;
ALTER TABLE appointments DROP CONSTRAINT IF EXISTS appointments_created_by_fkey CASCADE;
...
ALTER TABLE staff_schedules DROP CONSTRAINT IF EXISTS staff_schedules_new_staff_id_fkey CASCADE;
ALTER TABLE staff_schedules DROP CONSTRAINT IF EXISTS staff_schedules_staff_id_fkey CASCADE;
...
ALTER TABLE payment_transactions DROP CONSTRAINT IF EXISTS payment_transactions_new_staff_id_fkey CASCADE;
ALTER TABLE payment_transactions DROP CONSTRAINT IF EXISTS payment_transactions_staff_id_fkey CASCADE;
...
ALTER TABLE payment_transactions DROP CONSTRAINT IF EXISTS payment_transactions_new_settled_by_fkey CASCADE;
ALTER TABLE payment_transactions DROP CONSTRAINT IF EXISTS payment_transactions_settled_by_fkey CASCADE;
...
ALTER TABLE refunds DROP CONSTRAINT IF EXISTS refunds_new_refunded_by_fkey CASCADE;
ALTER TABLE refunds DROP CONSTRAINT IF EXISTS refunds_refunded_by_fkey CASCADE;
